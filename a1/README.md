...
## Special Thanks
This guide is based on the *opinionated Angular style guide for teams by [@john_papa](//twitter.com/john_papa)*.

## Purpose
The purpose of this style guide is to document the conventions that are expected to be applied to code contributed to the code base.
...
###### [Style [Y121](#style-y121)]
  ...
  - Use consistent names for all components following a pattern that describes the component's feature then its type (i.e. `feature.type.js`).
